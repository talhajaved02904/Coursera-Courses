...
bandit_posterior(data = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "W", "W", "W", "W", "L", "L", "L", "W", "L"))
)
```
...
new_data <- data.frame(machine = c(1L, 1L, 2L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("L", "W", "W", "L", "W", "L", "L", "L", "L", "L", "L", "L", "W", "W", "W", "L", "L", "L", "L", "W", "W", "W", "L", "W", "W", "W", "L", "L", "L", "L", "L", "W", "L", "L", "L", "W", "W", "L", "L", "L", "W", "W", "L", "W", "L", "W", "L", "L", "L", "L", "L", "L", "W", "W", "L", "W", "L", "W", "L", "L", "L", "W", "L", "W", "L", "W", "L", "W", "W", "L", "W", "L", "L", "W", "W", "L", "L", "L", "L", "W", "L", "W", "L", "L", "L", "W", "L", "W", "L", "L", "L", "W", "W", "L", "L", "W", "L", "L", "L", "W"))

plot_bandit_posterior(new_data)
```
...
* Both of the above. This is correct
</div>
