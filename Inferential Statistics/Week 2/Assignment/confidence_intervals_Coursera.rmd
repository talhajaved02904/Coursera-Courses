...
```{r set-seed}
set.seed(02904)                 # make sure to change the seed
```
...
<ol>
<li> True. This is the correct</li>
<li> False. </li>
</ol>
...
<ol>
<li> 95% of the time the true average area of houses in Ames, Iowa, will be in this interval. This one </li>
...
<li> 1.96 </li>
<li> 2.33 </li>
<li> 2.58. This one is correct </li>
</ol>
```{r find-99-perc-crit-val}
# type your code for the Question 5 here, and Knit
z_new <- qnorm(.005,lower.tail=FALSE)
z_new
```
