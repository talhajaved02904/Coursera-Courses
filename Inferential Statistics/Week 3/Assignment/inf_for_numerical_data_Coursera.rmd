...
<li> The births . This is correct</li>
</ol>
...
<li> Both distributions are extremely right skewed. This is false </li>
<li> The IQRs of the distributions are roughly equal. </li>
</ol>
```{r habit-weight-box}
# type your code for the Question 3 here, and Knit
boxplot(weight~habit, data=nc, col = "orange")
...
<li> We are 95% confident that babies born to nonsmoker mothers are on average 0.05 to 0.58 pounds heavier at birth than babies born to smoker mothers. I think this one</li>
</ol>
```{r habit-weight-ci}
...
<li>(6.9779 , 7.2241)</li>
<li>(38.0952 , 38.5742). This is correct</li>
</ol>
```{r weeks-ci-99}
...
```{r gained-mature-ht}
# type your code for the Exercise here, and Knit
inference(y = weight, x = mature, data = nc, statistic = "mean", type = "ht", null = 0,alternative = "two sided"  ,method = "theoretical")

```

7. Now, a non-inference task: Determine the age cutoff for younger and mature 
mothers. Use a method of your choice, and explain how your method works. Cut of is 34
```{r cutoff-mature}
...
Numerical = visits
categorical = whitemom



```{r pick-your-own}
# type your code for the Exercise here, and Knit
boxplot(visits~whitemom, data=nc, col = "orange")

inference(y = visits, x = premie, data = nc, statistic = "mean", type = "ht", null = 0, 
          alternative = "greater", method = "theoretical")
```
As p value is small, we can reject the null hypothesis
