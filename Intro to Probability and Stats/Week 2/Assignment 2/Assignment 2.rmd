...
<ol>
<li> N666DN This is the answer</li> 
<li> N755US </li> 
<li> N779JB </li> 
<li> N947UW </li> 
<li> N959UW </li> 
...
<li> There is an overall postive association between distance and average speed. This is the true one</li> 
...
nycflights %>%
  group_by(dep_type) %>%
  summarise(ontime = sum(arr_type == "on time")/n(), offtime = sum(arr_type == "delayed")/n())
